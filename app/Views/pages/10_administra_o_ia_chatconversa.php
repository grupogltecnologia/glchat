...
<body>
    ...
    <div class="app-layout">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/dashboard';">
                    <span class="menu-icon"><span class="material-symbols-rounded" aria-hidden="true">analytics</span></span>
                    <span class="menu-text">Dashboard</span>
                </a>
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/chat';">
                    <span class="menu-icon"><span class="material-symbols-rounded" aria-hidden="true">chat</span></span>
                    <span class="menu-text">Chat</span>
                </a>
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/agentes-ia';">
                ...
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/crm';">
                    <span class="menu-icon"><span class="material-symbols-rounded" aria-hidden="true">view_kanban</span></span>
                    <span class="menu-text">CRM</span>
                </a>
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/conexoes';">
                ...
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/disparos';">
                ...
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/contatos';">
                ...
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/ajuda';">
                    <span class="menu-icon"><span class="material-symbols-rounded" aria-hidden="true">help</span></span>
                    <span class="menu-text">Ajuda</span>
                </a>
                <a href="#" class="menu-item" onclick="window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/configuracoes';">
    ...
    <script type="module">
        ...
        async function fetchPlanos() {
            ...
            try {
                const { data: planosData, error } = await supabase.from('vw_Planos_Usuarios_Count').select('*').order('id');
                if (error) throw error;
        ...
        async function atualizarPlanoCliente(contaId, idPlano) {
            try {
                const { error } = await supabase.from('SAAS_Contas').update({ plano: Number(idPlano) }).eq('id', contaId);
                if (error) throw error;
                await fetchContas();
                return true;
            } catch (error) {
        ...
        async function bloquearUsuarioAPI(contaId) {
            try {
                const { error } = await supabase.from('SAAS_Contas').update({ status: false }).eq('id', contaId);
                if (error) throw error;
                await fetchContas();
                return true;
            } catch (error) {
        ...
        async function desbloquearUsuarioAPI(contaId) {
            try {
                const { error } = await supabase.from('SAAS_Contas').update({ status: true }).eq('id', contaId);
                if (error) throw error;
                await fetchContas();
                return true;
            } catch (error) {
        ...
        async function atualizarClienteAPI(contaId, dadosCliente) {
            try {
                const { error: errConta } = await supabase.from('SAAS_Contas').update({
                    status: dadosCliente.status,
                    dataValidade: dadosCliente.dataVencimento || null
                }).eq('id', contaId);
                if (errConta) throw errConta;
                const { data: usuarios } = await supabase.from('SAAS_Usuarios').select('id').eq('contaId', contaId).eq('funcao', 'admin').limit(1);
                if (usuarios && usuarios.length > 0 && (dadosCliente.nome != null || dadosCliente.telefone != null)) {
                    const up = {};
                    if (dadosCliente.nome != null) up.nome = dadosCliente.nome;
                    if (dadosCliente.telefone != null) up.telefone = dadosCliente.telefone;
                    if (Object.keys(up).length) await supabase.from('SAAS_Usuarios').update(up).eq('id', usuarios[0].id);
                }
                await fetchContas();
                return true;
            } catch (error) {
        ...
        // Função para excluir conta via Supabase (cascade remove SAAS_Usuarios)
        async function excluirUsuarioAPI(contaId) {
            try {
                const { error } = await supabase.from('SAAS_Contas').delete().eq('id', contaId);
                if (error) throw error;
                await fetchContas();
                return true;
            } catch (error) {
        ...
        async function fetchContas() {
            ...
            try {
                const { data: contasData, error } = await supabase.from('SAAS_Contas').select('*, SAAS_Planos(nome, preco)').order('created_at', { ascending: false });
                if (error) throw error;
                const raw = contasData || [];
                clientes = raw.map(c => {
                    const plano = c.SAAS_Planos || {};
                    return {
                        id: c.id,
        ...
        const EMAIL_LOGO_URL = 'https://qlennkosykcblbhpbmqt.supabase.co/storage/v1/object/public/arquivos/logo';
        const EMAIL_BOASVINDAS_LOGIN_URL = '/hublabel/public/hublabel/public/login';
...
<div class="wrapper">
        ...
        function wrapEmailForPreview(bodyHtml) {
            ...
            if (/^<style[\s>]/i.test(raw)) {
                return '<!DOCTYPE html><html><head><meta charset="utf-8">    <script src="/hublabel/public/assets/js/supabase-compat.js"></script>
</head><body style="margin:0;padding:16px;background:#0f172a;">' + raw + '</body></html>';
            }
            return '<!DOCTYPE html><html><head>' + EMAIL_PREVIEW_STYLES + '    <script src="/hublabel/public/assets/js/supabase-compat.js"></script>
        ...
        const CRIAR_USUARIO_URL = '/hublabel/public/criar-usuario';
        ...
        async function salvarPersonalizacaoWebhook(btnEl) {
            ...
            try {
                ...
                const res = await fetch(WEBHOOK_PERSONALIZAR_SAAS_URL, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(body)
                });
        ...
        function confirmarResetarCreditos(contaId) {
            ...
            if (cliente) {
                ...
                document.getElementById('confirmar-resetar-creditos').onclick = async () => {
                    ...
                    try {
                        await supabase.from('SAAS_AgentesIA').update({ creditosGasto: 0 }).eq('contaId', contaId);
                        await supabase.from('SAAS_Contas').update({ tokens: 0 }).eq('id', contaId);
        ...
        async function abrirModalVerUsuarios(contaId) {
            ...
            modal.style.display = 'flex';
            try {
                const { data: usuarios, error } = await supabase.from('SAAS_Usuarios').select('id, nome, "Email", funcao').eq('contaId', contaId).order('created_at');
                if (error) throw error;
                        ...
                        <tbody>
                            ${usuarios.map(u => {
                                ...
                                return `<tr>
                                    ...
                                    <td>
                                        <button type="button" class="ver-usuarios-btn-desv" data-usuario-id="${uid}" data-usuario-rotulo="${rotulo}" ${soUm ? 'disabled title="Não é possível remover o único usuário da conta"' : 'title="Eliminar registo em SAAS_Usuarios"'}>
                                            Desvincular
                                        </button>
                                    </td>
                                </tr>`;
        ...
        async function desvincularUsuarioSAAS(usuarioId, contaId, rotuloExibicao) {
            if (!usuarioId || !contaId || !supabase) {
                showError('Dados inválidos.');
                return;
            }
            const msg = `Desvincular ${rotuloExibicao || 'este usuário'}?\n\nO registro será excluído da tabela SAAS_Usuarios (perde o acesso a esta conta).`;
            if (!await showConfirmDialog(msg)) return;
            try {
                const { error } = await supabase.from('SAAS_Usuarios').delete().eq('id', usuarioId);
                if (error) throw error;
        ...
        document.addEventListener('DOMContentLoaded', async function() {
            ...
            document.getElementById('clientes-tab').addEventListener('click', () => switchTab('clientes'));
            document.getElementById('planos-tab').addEventListener('click', () => switchTab('planos'));
            document.getElementById('pv-tab').addEventListener('click', () => switchTab('pv'));
            document.getElementById('personalizacao-tab')?.addEventListener('click', () => switchTab('personalizacao'));
            document.getElementById('emails-tab').addEventListener('click', () => switchTab('emails'));
            document.getElementById('integracao-pagamento-tab')?.addEventListener('click', () => switchTab('integracao-pagamento'));
            ...
            try {
                ...
                if (!user) {
                    window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/dashboard';
                    return;
                }
                const { data: usuarioData } = await supabase.from('SAAS_Usuarios').select('super_admin').eq('auth_user_id', user.id).limit(1);
                const isSuperAdmin = usuarioData && usuarioData.length > 0 && usuarioData[0].super_admin === true;
                if (!isSuperAdmin) {
                    window.location.href = '/hublabel/public/hublabel/public/hublabel/public/hublabel/public/dashboard';
                    return;
                }
