    ...
    <span class="audio-player-time">0:00 / 0:00</span>
        ...
        async function confirmDeleteConversation() {
            ...
            try {
                ...
                const chatArea = document.getElementById('chatArea');
                if (chatArea) {
                    chatArea.innerHTML = '<div class="chat-empty" id="chatEmpty"><img src="https://qlennkosykcblbhpbmqt.supabase.co/storage/v1/object/public/arquivos/logo" alt="IA Chatconversa" class="chat-empty-logo"></div>';
                }
