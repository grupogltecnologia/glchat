<?php
/**
 * Criar Cadastro - HTML/CSS limpo do n8n
        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 relative">
            <div class="w-full max-w-md mx-auto flex flex-col justify-center min-h-full py-8 lg:py-12">
                ...
                <div class="mb-10 text-center">
                    <img src="https://qlennkosykcblbhpbmqt.supabase.co/storage/v1/object/public/arquivos/logo" alt="IA Chatconversa" class="h-12 sm:h-14 w-auto max-w-[min(100%,320px)] object-contain object-center mx-auto" width="320" height="112">
                    ...
                    <form id="cadastroForm" class="space-y-4">
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-sm font-medium text-slate-500">Já tem uma conta?
                                <a href="/hublabel/public/login" class="text-slate-900 font-extrabold hover:underline">Fazer Login</a>
                            </p>
                        </div>
                    </form>
...
<script src="/hublabel/public/assets/js/pages/cadastro.js"></script>
</body>
</html>
