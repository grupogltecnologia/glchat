<?php
/**
 * Detalhes do Disparo - HTML/CSS limpo do n8n
...
<!-- scripts removidos para manter somente HTML + CSS -->
        ...
        <div class="main-content custom-scroll">
            ...
            <div class="mb-8">
                <div class="flex items-center gap-2 text-xs font-bold text-slate-400 mb-4 uppercase tracking-widest">
                    <a href="#" class="hover:text-brand-500 transition-colors">Disparos</a>
                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    ...
                    <div class="header-actions flex flex-wrap items-center gap-3">
                        <a href="#" class="btn-voltar bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 px-5 py-2.5 rounded-xl text-sm font-bold shadow-sm transition-all flex items-center gap-2 no-underline">
                            <i class="fa-solid fa-arrow-left"></i> Voltar
                        </a>
                        <div class="disparo-actions relative">
                            <div class="actions-menu">
                                <button type="button" class="actions-trigger w-10 h-10 rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-brand-600 hover:border-brand-200 hover:bg-brand-50 flex items-center justify-center transition-all shadow-sm" aria-expanded="false" aria-haspopup="true" aria-controls="actionsDropdown">
                                    <i class="fa-solid fa-ellipsis-vertical" aria-hidden="true"></i>
                                </button>
                                <div class="actions-dropdown" id="actionsDropdown" role="menu" aria-label="Ações da campanha">
                                    <button type="button" class="actions-menu-item actions-menu-item--brand" role="menuitem">
                ...
                <div class="table-section bg-white rounded-3xl shadow-soft border border-slate-100 flex flex-col overflow-hidden mb-12">
                    ...
                    <div class="p-5 border-b border-slate-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-50/30">
                        ...
                        <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto sm:justify-end">
                            ...
                            <button type="button" id="btnExportar" class="bg-white border border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-50 text-xs font-bold px-4 py-2 rounded-lg shadow-sm transition-colors flex items-center gap-2 shrink-0" title="Exportar contatos">
    ...
    <div id="popupExportar" class="fixed inset-0 z-[9998] flex items-center justify-center bg-black/60 backdrop-blur-sm" style="display:none;">
        <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
            <div class="flex justify-between items-center mb-6">
                ...
                <button class="w-8 h-8 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 flex items-center justify-center transition-colors"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <p class="text-sm text-slate-500 mb-6">Selecione quais contatos deseja exportar em CSV:</p>
            <div class="space-y-3">
                <button class="btn-opcao-exportar w-full bg-slate-50 border border-slate-200 hover:border-brand-500 hover:bg-brand-50 text-slate-700 hover:text-brand-600 px-4 py-3 rounded-xl text-sm font-bold transition-all flex items-center gap-3"><i class="fa-solid fa-users text-slate-400"></i> Todos os contatos</button>
                <button class="btn-opcao-exportar w-full bg-slate-50 border border-slate-200 hover:border-brand-500 hover:bg-brand-50 text-slate-700 hover:text-brand-600 px-4 py-3 rounded-xl text-sm font-bold transition-all flex items-center gap-3"><i class="fa-solid fa-clock text-amber-400"></i> Apenas pendentes</button>
                <button class="btn-opcao-exportar w-full bg-slate-50 border border-slate-200 hover:border-brand-500 hover:bg-brand-50 text-slate-700 hover:text-brand-600 px-4 py-3 rounded-xl text-sm font-bold transition-all flex items-center gap-3"><i class="fa-solid fa-circle-xmark text-red-400"></i> Apenas falhas</button>
            </div>
        </div>
    </div>
    ...
    <div id="popupConexoes" class="fixed inset-0 bg-black/60 backdrop-blur-sm z-[9998] items-center justify-center" style="display:none;">
        <div class="bg-white rounded-2xl p-8 max-w-lg w-full mx-4 shadow-2xl max-h-[80vh] overflow-y-auto custom-scroll">
            ...
            <button class="w-full bg-brand-500 hover:bg-brand-600 text-white py-3 rounded-xl font-bold text-sm transition-colors shadow-sm">
...
<script src="/hublabel/public/assets/js/pages/detalhes_disparo.js"></script>
</body>
</html>