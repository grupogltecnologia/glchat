        ...
        <div class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 sm:p-12 relative">
            <div class="w-full max-w-md mx-auto flex flex-col justify-center min-h-full py-8 lg:py-12">
                ...
                <div class="mb-10 text-center">
                    <img src="/hublabel/public/assets/images/logo" alt="IA Chatconversa" class="h-12 sm:h-14 w-auto max-w-[min(100%,320px)] object-contain object-center mx-auto" width="320" height="112" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
