            ...
            <div class="w-full max-w-md mx-auto flex flex-col justify-center min-h-full py-8 lg:py-12">
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm font-medium text-slate-500">Ainda não tem uma conta?
                        <a href="/hublabel/public/cadastro" class="text-brand-600 font-extrabold hover:underline">Crie uma conta grátis</a>
                    </p>
                </div>
            </div>
...
<!-- JavaScript de login -->
<script src="/hublabel/public/assets/js/pages/login.js"></script>
